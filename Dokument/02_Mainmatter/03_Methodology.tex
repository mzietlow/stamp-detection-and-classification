...
\subsection{Single Shot MultiBox Detector} Two common one-stage architectures are
...
\subsubsection{SSD Architecture}\label{subsect:SSD Architecture}
...
\paragraph{Anchor generation} \todo{Anchor does not use glossary here!}
...
\paragraph{Default box size and aspect ratio}\label{verysubsect:Default box size and aspect ratio}
...
\subsubsection{Encoding Ground Truth} For training, ground truth bounding boxes \(B\)
